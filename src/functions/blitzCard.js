...
module.exports = async (username, score, spp, pps, aurl) => {
  ...
  if (aurl) {
    ...
    ctx.font = "80px hun";
    ctx.fillText("Score: " + score, 624, 242, 1866 - 624);
    ctx.fillText("SPP: " + spp, 624, 342, 1866 - 624);
    ctx.fillText("PPS: " + pps, 624, 442, 1866 - 624);
